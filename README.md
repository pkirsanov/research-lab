...
| [`🌴 Palm Springs Rental Market Lab`](palm-springs-rental-market-lab.html) | Source-qualified short-term-rental market research for **Palm Springs, California**: two pair-local segments (whole market + large-luxury 5+ BR), each independently covering **nine** research categories with source-qualified claims (AirDNA / Key Data / City of Palm Springs vacation-rental registries), **falsifiable** remaining-2026 and 2027 scenario matrices, and a luxury acquisition/financing baseline. Missing property economics stay **incomplete** (never zero); unknown luxury performance stays **unknown**. Simple and Power share one deterministic model, cross-linked to its Ocean Shores sibling and built on the shared [`rlrental.js`](rlrental.js) place-based engine. Educational only — not investment advice. | [`notes/place-based-rental-market-research.md`](notes/place-based-rental-market-research.md) |
| [`🏖️ Ocean Shores Rental Market Lab`](ocean-shores-rental-market-lab.html) | Source-qualified short-term-rental market research for **Ocean Shores, Washington** — the Pacific-coast sibling of the Palm Springs lab sharing the same [`rlrental.js`](rlrental.js) place-based method: two pair-local segments (whole market + large-luxury 5+ BR), **nine** research categories per unit, source-qualified claims, **falsifiable** remaining-2026 and 2027 scenario matrices, and a luxury acquisition/financing baseline. Missing economics stay **incomplete** (never zero); unknown performance stays **unknown**. Simple and Power share one deterministic model. Educational only — not investment advice. | [`notes/place-based-rental-market-research.md`](notes/place-based-rental-market-research.md) |
