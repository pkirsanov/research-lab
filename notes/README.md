...
| `palm-springs-rental-market-lab` | [place-based-rental-market-research.md](place-based-rental-market-research.md) | Re-verify the source-qualified claims and dated snapshots in `palm-springs-rental-market.payload.json` against the cited AirDNA / Key Data / City of Palm Springs registries; confirm the four pair-local units still validate through the shared `rlrental.js` engine (`node scripts/validate-place-based-rental-market.mjs`); keep luxury performance unknown and missing property economics incomplete (never zero); and refresh the remaining-2026 / 2027 scenario falsifiers. Shares the place-based method with the Ocean Shores lab. |
| `ocean-shores-rental-market-lab` | [place-based-rental-market-research.md](place-based-rental-market-research.md) | Re-verify the source-qualified claims and dated snapshots in `ocean-shores-rental-market.payload.json` against the cited AirDNA / Key Data / city + county registries; confirm the four pair-local units still validate through the shared `rlrental.js` engine; keep luxury performance unknown and missing property economics incomplete (never zero); and refresh the remaining-2026 / 2027 scenario falsifiers. Shares the place-based method with the Palm Springs lab. |
