...
These are proposal-first handoffs for the canonical Bubbles source repository. Run them serially. Each session may write exactly one proposal under `/Users/redacted/Projects/bubbles/improvements/` and must not implement framework changes until the owner reviews and explicitly approves that proposal.
...
**Repository:** `/Users/redacted/Projects/bubbles`
**Required agent:** Select the canonical source agent `/Users/redacted/Projects/bubbles/agents/bubbles.retro.agent.md` (`bubbles.retro`) or the canonical `/Users/redacted/Projects/bubbles/agents/bubbles.workflow.agent.md` in `framework-health` mode. Never use a downstream `.github/agents/` copy.
...
**Repository:** `/Users/redacted/Projects/bubbles`
**Required agent:** Canonical `/Users/redacted/Projects/bubbles/agents/bubbles.retro.agent.md` (`bubbles.retro`) under `framework-health`; no downstream copy.
...
**Repository:** `/Users/redacted/Projects/bubbles`
**Required agent:** Canonical `bubbles.retro` at `/Users/redacted/Projects/bubbles/agents/bubbles.retro.agent.md`, `target: framework`.
...
**Repository:** `/Users/redacted/Projects/bubbles`
**Required agent:** Canonical `/Users/redacted/Projects/bubbles/agents/bubbles.retro.agent.md` (`bubbles.retro`) under `framework-health`.
**Workflow:** `framework-health`, proposal-first only.
...
**Repository:** `/Users/redacted/Projects/bubbles`
**Required agent:** Canonical `/Users/redacted/Projects/bubbles/agents/bubbles.retro.agent.md` (`bubbles.retro`), `target: framework`.
