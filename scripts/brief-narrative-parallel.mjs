...
import { attentionAuthoredKeysInstruction, attentionCardBudgetInstruction, attentionSubjectMenuInstruction, attentionVerbContractInstruction } from './build-attention-items.mjs';
