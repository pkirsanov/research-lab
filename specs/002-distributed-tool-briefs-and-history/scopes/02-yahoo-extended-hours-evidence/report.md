...
**Command:** `node --test tests/market-session-evidence.foundation.e2e.mjs tests/market-session-evidence.functional.mjs tests/market-session-evidence.source.e2e.mjs tests/market-session-evidence.unit.mjs`
**Exit Code:** 0
**Output:**

```text
$ node --test tests/market-session-evidence.foundation.e2e.mjs tests/market-session-evidence.functional.mjs tests/market-session-evidence.source.e2e.mjs tests/market-session-evidence.unit.mjs
# tests 19
# pass 19
# fail 0
# cancelled 0
...
```text
$ python3 - recompute scopes/02-yahoo-extended-hours-evidence/scope.md#test-plan
ROWSHA_MATCH=9 MISMATCH=0
Exit Code: 0
```
