...
**Command:** `node --test tests/market-session-evidence.foundation.e2e.mjs tests/market-session-evidence.functional.mjs tests/market-session-evidence.unit.mjs tests/released-report-evidence.e2e.mjs`
**Exit Code:** 0
**Output:**

```text
$ node --test tests/market-session-evidence.foundation.e2e.mjs tests/market-session-evidence.functional.mjs tests/market-session-evidence.unit.mjs tests/released-report-evidence.e2e.mjs
# tests 20
# pass 20
# fail 0
# cancelled 0
...
```text
$ python3 - recompute scopes/03-cpi-release-evidence/scope.md#test-plan
