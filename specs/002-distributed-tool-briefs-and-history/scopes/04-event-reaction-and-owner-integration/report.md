...
**Command:** `node --test tests/distributed-briefs-owner-canary.mjs tests/distributed-briefs-owner-reads.e2e.mjs tests/distributed-briefs-owner-reads.integration.mjs tests/distributed-briefs.contract.mjs tests/event-market-reaction.e2e.mjs tests/event-market-reaction.functional.mjs tests/market-session-evidence.source.e2e.mjs tests/market-session-evidence.unit.mjs tests/released-report-evidence.e2e.mjs`
**Exit Code:** 0
**Output:**

```text
$ node --test tests/distributed-briefs-owner-canary.mjs tests/distributed-briefs-owner-reads.e2e.mjs \
    tests/distributed-briefs-owner-reads.integration.mjs tests/distributed-briefs.contract.mjs \
    tests/event-market-reaction.e2e.mjs tests/event-market-reaction.functional.mjs \
    tests/market-session-evidence.source.e2e.mjs tests/market-session-evidence.unit.mjs \
...
```text
$ python3 - recompute scopes/04-event-reaction-and-owner-integration/scope.md#test-plan
