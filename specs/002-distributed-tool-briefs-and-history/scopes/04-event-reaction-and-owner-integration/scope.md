...
- [x] [TP-04-08] Scenario-specific E2E regression tests for EVERY new/changed/fixed behavior in SCN-002-026 pass with the exact title. — Evidence: [report.md](report.md#tp-04-07-and-tp-04-08-e2e-regression); `Regression: SCN-002-026 final-eligible evidence exists only after an owning read publishes its interpretation` GREEN, 1/1 exit 0.
