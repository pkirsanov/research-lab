...
- [x] Scenario-specific E2E regression tests for EVERY new/changed/fixed behavior in SCN-002-025 pass with the exact title. [TP-08-06] — Evidence: [report.md](report.md#four-window-policy-matrix-rlcontractsjswindowpolicy-derived-validated-by-tp-08-06) (final.e2e four-window regression GREEN; real evidence)
