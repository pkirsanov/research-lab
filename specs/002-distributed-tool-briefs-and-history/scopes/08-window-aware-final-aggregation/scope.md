...
- [x] [TP-08-06] Scenario-specific E2E regression tests for EVERY new/changed/fixed behavior in SCN-002-025 pass with the exact title. — Evidence: [report.md](report.md#four-window-policy-matrix-rlcontractsjswindowpolicy-derived-validated-by-tp-08-06) (final.e2e four-window regression GREEN; real evidence)
...
- [x] [TP-08-08] Broader E2E regression suite passes for author-lifecycle-history-final behavior. — Evidence: [report.md](report.md#tp-08-08-tp-08-09-broader-author-lifecycle-history-final-e2e-regression-and-baseline-repository-selftest-green) (authorship+history+final 7/7; real evidence)
