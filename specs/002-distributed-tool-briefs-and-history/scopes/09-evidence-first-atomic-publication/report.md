...
**Command:** `node --test tests/distributed-briefs.final.e2e.mjs tests/distributed-briefs.git-isolation.integration.mjs tests/distributed-briefs.history.e2e.mjs tests/distributed-briefs.scheduler-failures.integration.mjs tests/distributed-briefs.scheduler.canary.mjs tests/distributed-briefs.scheduler.e2e.mjs tests/distributed-briefs.scheduler.integration.mjs tests/distributed-briefs.scheduler.unit.mjs`
**Exit Code:** 0
**Output:**

```text
$ node --test tests/distributed-briefs.final.e2e.mjs tests/distributed-briefs.git-isolation.integration.mjs \
    tests/distributed-briefs.history.e2e.mjs tests/distributed-briefs.scheduler-failures.integration.mjs \
    tests/distributed-briefs.scheduler.canary.mjs tests/distributed-briefs.scheduler.e2e.mjs \
    tests/distributed-briefs.scheduler.integration.mjs tests/distributed-briefs.scheduler.unit.mjs
# tests 14
# pass 14
# fail 0
...
```text
$ python3 - recompute scopes/09-evidence-first-atomic-publication/scope.md#test-plan
ROWSHA_MATCH=14 MISMATCH=0
Exit Code: 0
```
