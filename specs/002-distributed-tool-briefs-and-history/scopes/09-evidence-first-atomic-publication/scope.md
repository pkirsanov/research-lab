...
- [x] [TP-09-03] Integration evidence passes for one full isolated-worktree transaction and temporary remote. — Evidence: [report.md](report.md#red-before-green-per-row-controlled-mutation-observed-failure-byte-exact-restore) (real evidence)
...
- [x] [TP-09-05] Integration evidence passes for every required-phase fault with prior pointers exact. — Evidence: [report.md](report.md#red-before-green-per-row-controlled-mutation-observed-failure-byte-exact-restore) (real evidence)
