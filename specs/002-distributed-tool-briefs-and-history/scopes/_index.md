...
| --- | --- | --- | --- | --- |
| 01 | [MarketSessionEvidence foundation](01-market-session-evidence-foundation/scope.md) | - | `rlcontracts.js`, `rlsession.js`, contract vectors | In Progress |
...
| 03 | [CPI release evidence](03-cpi-release-evidence/scope.md) | 01 | BLS adapters, consensus artifacts, report evidence | In Progress |
