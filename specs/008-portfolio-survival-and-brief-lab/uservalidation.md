# User Validation: Portfolio Survival And Brief Lab

Planning authority: [spec.md](spec.md), [design.md](design.md), and the [scope index](scopes/_index.md). Execution evidence is recorded in the sixteen per-scope reports under [scopes/](scopes/).

## Journey Goal

A research user can keep one private local portfolio and explicit mandate, receive a truthful four-window research queue, inspect risk/path/diversification/allocation tradeoffs, and audit every assumption and boundary without personal-data publication, hidden profiling, advice, or execution.

## Success Signal

Portfolio Brief, Risk X-Ray, Path Lab, Diversification, Allocation Comparison, and Research Dossier project one frozen portfolio/evidence identity. Every material value and action exposes source/authority, freshness/cutoff, method, uncertainty, lifecycle and invalidation; partial truth stays partial; clearing is mechanically verifiable; Simple/Power, desktop/mobile, canvases/tables, and deep links do not change conclusions or leak personal state.

## Planning Initialization

- [x] The acceptance baseline is anchored to SCN-008-001 through SCN-008-036, FR-001 through FR-150, NFR-001 through NFR-024, the complete UX contract, and the design's private-store, brief, analytics, route, and shared-extension contracts.
- [x] The executable plan uses sixteen isolated per-scope directories, four `foundation:true` scopes, strict dependencies, adjacent evidence files, exact persistent regression titles, and one atomic final registration transaction.
- [x] The validation contract uses Research Lab's build-free Node commands and checkout-local Playwright `1.61.1` `system-chrome` project over real fixture-overlay HTTP servers with no browser interception, service worker, or external provider.
- [x] These checked planning-initialization items assert artifact setup only; they do not certify implementation, test execution, a live route, or human acceptance.
...
- [Scope 01 private import/store evidence](scopes/01-private-portfolio-import-and-atomic-store/report.md)
- [Scope 02 mandate/cash-need evidence](scopes/02-mandate-and-cash-need-authority/report.md)
- [Scope 03 behavior/privacy evidence](scopes/03-local-behavior-privacy-inventory-and-clear/report.md)
- [Scope 04 public-boundary/coverage evidence](scopes/04-public-evidence-barrier-and-coverage/report.md)
- [Scope 05 four-window brief evidence](scopes/05-four-window-direct-scope-brief/report.md)
- [Scope 06 action lifecycle evidence](scopes/06-explainable-research-action-lifecycle/report.md)
- [Scope 07 return/drawdown evidence](scopes/07-return-and-drawdown-x-ray/report.md)
- [Scope 08 concentration/CAPM/contribution evidence](scopes/08-concentration-capm-and-risk-contribution/report.md)
- [Scope 09 dependent-path evidence](scopes/09-dependent-path-reproducibility/report.md)
- [Scope 10 cash-need/survival evidence](scopes/10-dated-cash-needs-and-survival-states/report.md)
- [Scope 11 stress/tail/alternative evidence](scopes/11-stress-tail-and-alternative-dependence/report.md)
- [Scope 12 hedge evidence](scopes/12-hedge-variant-research/report.md)
- [Scope 13 six-method allocation evidence](scopes/13-six-method-allocation-basis-and-feasibility/report.md)
- [Scope 14 sensitivity/Black-Litterman evidence](scopes/14-allocation-sensitivity-and-explicit-black-litterman/report.md)
- [Scope 15 dossier/claim-boundary evidence](scopes/15-walk-forward-research-dossier-and-claim-boundaries/report.md)
- [Scope 16 integrated release evidence](scopes/16-integrated-route-accessibility-and-atomic-release/report.md)
