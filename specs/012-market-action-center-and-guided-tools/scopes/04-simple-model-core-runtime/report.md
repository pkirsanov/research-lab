...
✖ TP-04-01 compute identity excludes occurrence retrieval view and storage time while retaining semantics cutoff seed and scenario (14.550703ms)
  AssertionError [ERR_ASSERTION]: Expected values to be strictly equal:
      at TestContext.<anonymous> (file:///home/redacted/research-lab/tests/simple-models.unit.mjs:238:10)
...
(`repo-binding-preflight.sh --repo-root /home/redacted/research-lab --agent-source research-lab`
→ `OK`, exit 0). All work confined to `/home/redacted/research-lab`. Net production change is
