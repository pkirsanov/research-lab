...
| TP-02-18 | Broader Regression E2E | e2e-ui | SCN-021-*, SCN-022-001 … -006 | `lifetime-tax-preferential.spec.mjs`, `lifetime-tax-surtax.spec.mjs`, Feature 021's five specs | The cumulative browser suite over the real route | `npx --no-install playwright test --config=playwright.config.mjs --project=system-chrome --grep "SCN-02" --reporter=list` | Yes | `report.md#tp-02-18` |
