...
| TP-04-19 | Broader Regression E2E | e2e-ui | SCN-021-*, SCN-022-001 … -012 | Feature 021's five specs plus this feature's four | The cumulative browser suite over the real route | `npx --no-install playwright test --config=playwright.config.mjs --project=system-chrome --grep "SCN-02" --reporter=list` | Yes | `report.md#tp-04-19` |
