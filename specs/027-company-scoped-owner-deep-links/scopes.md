...
| Field | Value |
| --- | --- |
| Status | In Progress — implemented and verified; 22 of 24 DoD items ticked with executed evidence, 2 stay unticked and are routed to `bubbles.plan` |
| Priority | P1 |
| Depends On | none |
| Tag | foundation:true |
...
| Field | Value |
| --- | --- |
| Status | In Progress — implemented and verified; 24 of 26 DoD items ticked with executed evidence, 2 stay unticked and are routed to `bubbles.plan` |
| Priority | P1 |
...
| Field | Value |
| --- | --- |
| Status | In Progress — implemented and verified; 22 of 23 DoD items ticked with executed evidence, 1 stays unticked and is routed to `bubbles.plan` |
| Priority | P1 |
