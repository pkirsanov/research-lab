...
| S5-T03 | Collision canary | integration | SCN-BUG001-011 | `tests/feature-004-collision-invariant.test.mjs` - Feature 004 hunk identity | Feature-004-shaped work leaves every foreign uncommitted hunk byte-identical, and each of the ten destructive operations is caught rather than silently tolerated. | `node --test tests/feature-004-collision-invariant.test.mjs` | No |
