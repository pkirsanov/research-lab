...
- [ ] The user-visible consequence was observed in a browser. **Left unticked deliberately. That a reader lands on the route's default is derived from the total absence of a reader, not from a runtime observation. Scope 2's Definition of Done requires the browser proof, and a filing packet does not supply it.**
