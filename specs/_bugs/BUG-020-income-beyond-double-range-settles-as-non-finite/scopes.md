...
- [x] Broader E2E regression suite passes for the complete lifetime-tax browser family after the non-finite-figure refusal behavior. **Claim Source:** executed. → Evidence: [BUG-020 report](report.md), `The Lifetime-Tax Browser Suite`, records `105 passed`, exit 0.
...
- [x] Scenario-specific E2E regression tests for every new/changed/fixed behavior pass for SCN-020-04 and SCN-020-05. **Claim Source:** executed. → Evidence: [BUG-020 report](report.md), `The Reported Pair, Asserted In Its Own Right`, records both exact boundary titles in the eight-test file run at `8 passed`, exit 0; the scenario manifest preserves both persistent links.
- [x] Broader E2E regression suite passes for the complete lifetime-tax browser family after both representability-boundary cases. **Claim Source:** executed. → Evidence: [BUG-020 report](report.md), `The Lifetime-Tax Browser Suite`, records `105 passed`, exit 0.
