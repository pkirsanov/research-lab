...
/* ------------------------------------------------------------------ TP-27-04
   The adversarial carrier.

   Each case rebuilds the SHIPPED document with one accessibility affordance
   removed and serves that disposable copy to the browser for the length of one
   assertion. Nothing is written to the working tree, and nothing is mutated in
   place: the mutation lives only in the string handed to `route.fulfill`.
